...
import com.unrestrained.adapter.ListBaseAdapter;
import com.unrestrained.entity.ItemModel;
import com.unrestrained.utils.AppToast;
import com.unrestrained.utils.Utils;
...
public class SwipeRefreshLayoutActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (mSwipeRefreshLayout != null) {
            mSwipeRefreshLayout.setProgressViewOffset(false, 0, Utils.dip2px(this, 48));
    ...
    private void requestData() {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                //模拟一下网络请求失败的情况
                if (Utils.isNetAvailable(SwipeRefreshLayoutActivity.this)) {
